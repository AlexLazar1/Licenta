    ...
    <div class="w-full max-w-sm">
      ...
      <form class="mt-8 bg-white rounded-lg shadow-lg overflow-hidden" @submit.prevent="submit">
        <div class="px-10 py-12">
          ...
          <text-input v-model="form.email" :errors="$page.errors.email" class="mt-10" label="Email" type="email" autofocus autocapitalize="off" :required="true" />
          <text-input v-model="form.password" class="mt-6" label="Password" type="password" :required="true" />
        ...
        <div class="px-10 py-4 bg-grey-lightest border-t border-grey-lighter flex justify-between items-center">
          <inertia-link class="text-green-dark hover:text-green-darker" :href="route('register')">Register here!</inertia-link>
